...
class TestClass(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_user = User('gilbert','XyZ3thf1')

    def test_init(self):
        """
        test case to chek if the object has been initialized correctly
        """
        self.assertEqual(self.new_user.username,'gilbert')
        self.assertEqual(self.new_user.password,'XyZ3thf1')

    def test_save_user(self):
        """
        test case to test if a new user instance has been saved 
...
class TestCredentials(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_credential = Credentials('Gmail','gilbert','yx5Gij43')
    def test_init(self):
        """
        Test case to check if a new Credentials instance has been initialized correctly
        """
        self.assertEqual(self.new_credential.account,'Gmail')
        self.assertEqual(self.new_credential.userName,'gilbert36')
    ...
    def test_save_many_accounts(self):
        ...
        '''
        self.new_credential.save_details()
        test_credential = Credentials("Twitter","gilbert","Mfh45hfk") 
    ...
    def test_credential_exist(self):
        ...
        """
        self.new_credential.save_details()
        the_credential = Credentials("Twitter", "gilbert", "Mfh45hfk")  
